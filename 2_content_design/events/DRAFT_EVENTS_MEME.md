...
- **标题**: 导师的召唤
- **描述**: 深夜，手机屏幕亮起，是导师的消息："在？来我办公室一下"。光标在输入框里闪烁，等待你的回复…
- **选项**:
    1. **【光速抵达】** -> **后果**: 导师让你帮他P张全家福。
    2. **【假装没看见】** -> **后果**: 获得一夜安宁。第二天组会被迫C位出道。
    3. **【线上装忙】** -> **后果**: 导师用你刚发的朋友圈截图回复了你。

### ID: DATA_BEAUTIFICATION
- **标题**: 美学胜利
- **描述**: 你的实验操作出了严重失误，本应直接丢弃。但你惊恐地发现，采集到的数据却完美得像教科书里的示例。
- **选项**:
    1. **【隐瞒过程，发表结果】** -> **后果**: 论文发表了。你开始在每个惊醒的夜里祈祷没人复现。
    2. **【忠于事实，丢弃数据】** -> **后果**: 良心很安宁，毕业很遥远。
    3. **【请示导师】** -> **后果**: 导师严厉地批评了你，然后让你重复实验，直到再次获得这个"完美的错误"。

### ID: CONCRETE_SPAGHETTI_CODE
- **标题**: 绝望的食谱
- **描述**: 如果你的项目成了一碗意大利面，散发着绝望的气息。你举起了手中的叉子…
- **选项**:
    1. **【拌上混凝土】** -> **后果**: 代码没了，你的精神状态稳定多了。
    2. **【含泪吃下去】** -> **后果**: 喜提"学术消化不良"诅咒，任何新功能都会让你呕吐。
    3. **【再加点调料】** -> **后果**: 没人能看懂你的代码，包括你自己。
