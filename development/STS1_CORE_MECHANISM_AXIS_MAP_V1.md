...
- Watcher: `stance_mantra`, retained setup, `copy_exactness`, and threshold closure.
...
### P1: First Slice Represented

The first P1 family now has reviewed viability coverage:
