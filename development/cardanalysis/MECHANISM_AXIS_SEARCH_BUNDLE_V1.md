...
Run a bounded axis-first draft writing rehearsal. The draft file is still supplied
outside runtime synthesis, but the rehearsal records the search/brief/seed/handoff
context and requires the draft to flow back through `autonomous_card_package_design_run_v1`:
