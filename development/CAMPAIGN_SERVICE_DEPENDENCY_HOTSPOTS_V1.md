...
- `contexts/campaign/services/track_block_service.py`
  ...
  - status: hotspot, but intentionally not in this task
  - reason: mostly board geometry and runtime mutation rules; do not force repository-style or facade-style abstraction here yet
...
- Not worth forcing right now:
  ...
  - `track_block_service` while it is still dominated by board geometry rules
- Rule of thumb:
