...
- Write a discipline profile contract template:
  - `python scripts/validate_discipline_profile.py --write-template <path>`
- Validate a discipline profile file or fixture directory:
  - `python scripts/validate_discipline_profile.py --input <path>`
- Validate the discipline profile contract:
