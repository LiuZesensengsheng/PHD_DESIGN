...
### 特殊事件：理想降临（Ideal's Advent）
- 定义：极罕见的“神迹时刻”变体。你抽到的“天命之牌”若恰好是你在组会中确立的“课题卡牌”，将自动触发一次壮观演出。
- 你会看到：角色背后出现“学术武魂”虚影，与本体同时出手，卡牌主效果结算两次（仅当回合生效）。
- 不需要你做选择：该牌本回合费用=0；不改变卡牌本体，也不会新增持续被动。
- 频率：每场战斗最多 1 次，可能整局不触发。
- 台词提示：第一幕内心独白、第三幕颜色终结句，帮助你读懂发生了什么。
