# 设计文档：理想-烛火系统 v4.0 (The Ideal-Candelabrum System)
...
*   **触发时机**: 当玩家的**压力值首次达到100**时。
*   **审判仪式**: 玩家会被带到一个象征内心世界的黑暗空间，面前是那个烛台。系统会优先选择一支**火焰摇曳**的蜡烛作为考验对象。
*   **审判机制**: 考验结果由玩家长期的**“心智光谱” (Sanity Spectrum)** 决定，导向两种命运：
...
*   **效果**:
    ...
    2.  在**本场战斗的剩余时间里**，该理想将升华为一个极其强大的**“美德”形态**。
    3.  玩家的压力值会得到一次**中等程度的削减**。
*   **“美德”示例**:
...
*   当考验结果为“牺牲”时：
    ...
    2.  玩家的压力会得到一次**大幅度的削减**（这是“牺牲”换来的短期喘息）。
...
*   **压力100**:
    *   **当理想尚存时**: 触发“初心的考验”，牺牲一个理想以换取喘息。事件结束后，压力值会重置到一个较低水平。
    *   **当所有理想都已熄灭时**: 直接触发下文所述的**“燃尽”**事件，游戏结束。
