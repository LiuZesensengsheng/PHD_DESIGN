...
当前还有 60 条中文场景等待人工审核。它们已经被翻译成人可读的问题，但仍然只是待审队列：
...
下一轮优先做一个小批次的中文审核包 06，建议切到“已有人类偏好周边的细分反例”：连锁疲劳细粒度、抽牌重复疲劳、能量债务表达、套件启动器密度。这样能更接近后续 reviewed seed 的证据形状，但仍然只进入待审队列。
