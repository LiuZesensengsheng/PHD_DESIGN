...
当前还有 75 条中文场景等待人工审核。它们已经被翻译成人可读的问题，但仍然只是待审队列：
...
下一轮优先做队列卫生或审核包 07。如果继续生成审核包，建议聚焦 packet 02-06 中尚未覆盖充分的“反例与停止线”：哪些场景应该合并、哪些问题太抽象、哪些条目需要打回重写。这样能减少待审积压的噪音，但仍然只进入待审队列。
