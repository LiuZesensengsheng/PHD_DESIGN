---
docmost_id: "019e6f70-b509-713b-abd6-c9eed1c75f6b"
slug_id: "WIKIDESGN1"
title: "设计总览"
status: "active"
space: "General"
...
- Status: `active`
- Path: `PHDGAME 正式 Wiki / 设计总览`
- Slug: `WIKIDESGN1`

## Content

来源：docs/wiki/design.md
...
DESIGN_NORTH_STAR_V1.md



活跃北极星。用于判断敌人、遭遇、事件和卡牌是否有共鸣、感动、乐趣和谈资。
...
活跃规则。用于区分 Active、Draft、Reference、Future、Archive。
...
先提出低风险候选：临时文件、重复旧稿、乱码笔记、已解压保留的原始包。



对价值不清楚的设计材料，优先标记为草案、参考、未来、归档或被替代。
