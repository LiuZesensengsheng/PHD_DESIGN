...
- 权威性: Yes, generated from docs/project/planning/*.json
- 最后复核: 2026-05-30

## 说明

本页由 `python scripts/generate_project_planning_dashboard.py` 生成。请先修改 `goals.json`、`requirements.json` 或 `tasks.json`，再重新生成。
